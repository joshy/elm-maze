...
Elm.Cell.make = function (_elm) {
   ...
   var _op = {};
   var gridLine = function (c) {    return _U.update($Graphics$Collage.defaultLine,{color: c,cap: $Graphics$Collage.Padded});};
   var wall = function (color) {    return $Graphics$Collage.traced(gridLine(color));};
   var singleWall = F2(function (cell,w) {
      var hh = cell.height / 2;
      var hw = cell.width / 2;
      var _p0 = w;
      switch (_p0.ctor)
      {case "N": return A2($Graphics$Collage.segment,{ctor: "_Tuple2",_0: 0 - hw,_1: hh},{ctor: "_Tuple2",_0: hw,_1: hh});
         case "E": return A2($Graphics$Collage.segment,{ctor: "_Tuple2",_0: hw,_1: hh},{ctor: "_Tuple2",_0: hw,_1: 0 - hh});
         case "S": return A2($Graphics$Collage.segment,{ctor: "_Tuple2",_0: hw,_1: 0 - hh},{ctor: "_Tuple2",_0: 0 - hw,_1: 0 - hh});
